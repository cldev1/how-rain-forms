    ...
    case "drops":
      return (
        <svg {...common}>
          ...
          />
          <path
            d="M16 18c0-3 2.5-7 4-9 1.5 2 4 6 4 9a4 4 0 11-8 0z"
            fill="#7EC8FF"
          />
          <path
            d="M26 22c0-2.5 2-6 3.2-7.5 1.2 1.5 3.3 5 3.3 7.5a3.25 3.25 0 11-6.5 0z"
            fill="#A8DCFF"
          />
    ...
    case "drizzle":
      return (
        <svg {...common}>
          ...
          />
          <path
            d="M16 28v6M22 27v7M28 28v6M34 27v5"
            stroke="#8EC8F0"
            strokeWidth="2.2"
            strokeLinecap="round"
            opacity="0.75"
    ...
    case "rain":
      return (
        <svg {...common}>
          ...
          />
          <path
            d="M14 26v10M20 24v12M26 26v10M32 24v11M38 27v8"
            stroke="#6EB0E0"
            strokeWidth="2.4"
            strokeLinecap="round"
          />
    ...
    case "heavy":
      return (
        <svg {...common}>
          ...
          />
          <path
            d="M12 24v14M18 22v16M24 24v14M30 22v15M36 25v12"
            stroke="#4A90C8"
            strokeWidth="2.8"
            strokeLinecap="round"
          />
    ...
    case "storm":
      return (
        <svg {...common}>
          ...
          />
          <path
            d="M26 20l-8 10h6l-3 12 12-14h-7l6-8z"
            fill="#FFE566"
            stroke="#F0C040"
            strokeWidth="1"
            strokeLinejoin="round"
